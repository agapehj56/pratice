...
--
insert into bookState values(201700056, '홍길동', 11114260, '대여',to_date('27-02-2017','dd-mm-yyyy'));
insert into bookState values(201601320, '심청이', 9010083, '대여',to_date('15-03-2017','dd-mm-yyyy'));
insert into bookState values(201616589, '한영희', 14125167, '예약',to_date('20-03-2017','dd-mm-yyyy'));
insert into bookState values(201700057, '장희원', 5127821, '예약',to_date('02-03-2017','dd-mm-yyyy'));
